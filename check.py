...
plt.legend()
plt.savefig("classics/pngs/half_shape/LCURVE_check_-500.png")
#plt.show()
...
plt.legend()
plt.savefig("classics/pngs/half_shape/SR_check_-500.png")
#plt.show()
...
plt.legend()
plt.savefig("classics/pngs/half_shape/Steps_check_-500.png")
#plt.show()